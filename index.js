      ...
      .toArray(function (err, snapshots) {
        ...
        self.events.find(criteria)
          ...
          .toArray(function (err, events) {
            ...
            var entity = self.deserialize(id, snapshot, events);
    ...
    self.events.find(criteria)
      ...
      .toArray(function (err, events) {
        ...
        ids.forEach(function (id) {
          ...
          var entity = self.deserialize(id, snapshot, evnts);
          results.push(entity);
        });
...
Repository.prototype.deserialize = function deserialize (id, snapshot, events) {
